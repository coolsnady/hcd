...
reason, the hcd suite has a formalized and rigorous development process which
...
- [Effective Go](http://golang.org/doc/effective_go.html) - The entire hcd
...
One of the major design goals of all core hcd packages is to aim for complete
...
contributions.  This is how to get your changes into hcd.
...
Rejoice as you will now be listed as a [contributor](https://github.com/coolsnady/hcd/graphs/contributors)!
...
[ISC license](https://github.com/coolsnady/hcd/blob/master/LICENSE).  This is

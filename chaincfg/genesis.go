	...
	TxIn: []*wire.TxIn{
		{
			...
			SignatureScript: []byte{
				0x04, 0xff, 0xff, 0x00, 0x1d, 0x01, 0x04, 0x40,
				0x54, 0x65, 0x63, 0x68, 0x43, 0x72, 0x75, 0x6e,
				0x63, 0x68, 0x20, 0x30, 0x33, 0x2f, 0x4d, 0x61,
				0x72, 0x2f, 0x32, 0x30, 0x31, 0x38, 0x20, 0x47,
				0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x27, 0x73, 0x20,
				0x6e, 0x65, 0x77, 0x20, 0x42, 0x72, 0x69, 0x73,
				0x74, 0x6c, 0x65, 0x63, 0x6f, 0x6e, 0x65, 0x20,
				0x70, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x6f,
				0x72, 0x20, 0x62, 0x72, 0x69, 0x6e, 0x67, 0x73,
				0x20, 0x69, 0x74, 0x20, 0x6f, 0x6e, 0x65, 0x20,
				0x73, 0x74, 0x65, 0x70, 0x20, 0x63, 0x6c, 0x6f,
				0x73, 0x65, 0x72, 0x20, 0x74, 0x6f, 0x20, 0x71,
				0x75, 0x61, 0x6e, 0x74, 0x75, 0x6d, 0x20, 0x73,
				0x75, 0x70, 0x72, 0x65, 0x6d, 0x61, 0x63, 0x79,
			},
			Sequence:    0xffffffff,
...
var genesisBlock = wire.MsgBlock{
	Header: wire.BlockHeader{
		...
		Timestamp:    time.Unix(1522952251, 0), // Changed for dev use
...
var testNet2GenesisBlock = wire.MsgBlock{
	Header: wire.BlockHeader{
		...
		Timestamp:    time.Unix(1522952251, 0), // 2018-04-05 TestNet1
		Bits:         0x1e00ffff,
		SBits:        20000000,
		Nonce:        0x18aea41a,
		StakeVersion: 0,

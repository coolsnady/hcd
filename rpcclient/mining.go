...
func (c *Client) SubmitBlockAsync(block *hxutil.Block, options *dcrjson.SubmitBlockOptions) FutureSubmitBlockResult {
	blockHex := ""
	if block != nil {
...
func (c *Client) SubmitBlock(block *hxutil.Block, options *dcrjson.SubmitBlockOptions) error {

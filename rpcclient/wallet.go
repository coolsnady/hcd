...
func (c *Client) ListUnspentMinMaxAddressesAsync(minConf, maxConf int, addrs []hxutil.Address) FutureListUnspentResult {
...
func (c *Client) SendToAddress(address hxutil.Address, amount hxutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendToAddressCommentAsync(address hxutil.Address,
	amount hxutil.Amount, comment,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendToAddressComment(address hxutil.Address, amount hxutil.Amount, comment, commentTo string) (*chainhash.Hash, error) {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFrom(fromAccount string, toAddress hxutil.Address, amount hxutil.Amount) (*chainhash.Hash, error) {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromMinConf(fromAccount string, toAddress hxutil.Address, amount hxutil.Amount, minConfirms int) (*chainhash.Hash, error) {
...
func (c *Client) SendFromCommentAsync(fromAccount string,
	toAddress hxutil.Address, amount hxutil.Amount, minConfirms int,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromComment(fromAccount string, toAddress hxutil.Address,
	amount hxutil.Amount, minConfirms int,
...
func (c *Client) SendManyAsync(fromAccount string, amounts map[hxutil.Address]hxutil.Amount) FutureSendManyResult {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendMany(fromAccount string, amounts map[hxutil.Address]hxutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendManyCommentAsync(fromAccount string,
	amounts map[hxutil.Address]hxutil.Amount, minConfirms int,
...
func (c *Client) PurchaseTicketAsync(fromAccount string,
	spendLimit hxutil.Amount, minConf *int, ticketAddress hxutil.Address,
	numTickets *int, poolAddress hxutil.Address, poolFees *hxutil.Amount,
	expiry *int, ticketChange *bool, ticketFee *hxutil.Amount) FuturePurchaseTicketResult {
...
func (c *Client) PurchaseTicket(fromAccount string,
	spendLimit hxutil.Amount, minConf *int, ticketAddress hxutil.Address,
	numTickets *int, poolAddress hxutil.Address, poolFees *hxutil.Amount,
	expiry *int, ticketChange *bool, ticketFee *hxutil.Amount) ([]*chainhash.Hash, error) {
...
func (r FutureAddMultisigAddressResult) Receive() (hxutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return hxutil.DecodeAddress(addr)
}
...
func (c *Client) AddMultisigAddressAsync(requiredSigs int, addresses []hxutil.Address, account string) FutureAddMultisigAddressResult {
...
func (c *Client) AddMultisigAddress(requiredSigs int, addresses []hxutil.Address, account string) (hxutil.Address, error) {
...
func (c *Client) CreateMultisigAsync(requiredSigs int, addresses []hxutil.Address) FutureCreateMultisigResult {
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.String())
	}
...
// address.
func (r FutureGetNewAddressResult) Receive() (hxutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetNewAddress(account string) (hxutil.Address, error) {
...
func (c *Client) GetNewAddressGapPolicy(account string, gapPolicy GapPolicy) (hxutil.Address, error) {
...
func (r FutureGetRawChangeAddressResult) Receive() (hxutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetRawChangeAddress(account string) (hxutil.Address, error) {
...
func (r FutureGetAccountAddressResult) Receive() (hxutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetAccountAddress(account string) (hxutil.Address, error) {
...
func (c *Client) GetAccount(address hxutil.Address) (string, error) {
...
func (r FutureGetAddressesByAccountResult) Receive() ([]hxutil.Address, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	addrs := make([]hxutil.Address, 0, len(addrStrings))
...
// passed account.
func (c *Client) GetAddressesByAccount(account string) ([]hxutil.Address, error) {
...
func (r FutureListAccountsResult) Receive() (map[string]hxutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	accountsMap := make(map[string]hxutil.Amount)
	for k, v := range accounts {
		amount, err := hxutil.NewAmount(v)
		if err != nil {
			return nil, err
		}
...
func (c *Client) ListAccounts() (map[string]hxutil.Amount, error) {
...
func (c *Client) ListAccountsMinConf(minConfirms int) (map[string]hxutil.Amount, error) {
...
func (r FutureGetReceivedByAccountResult) Receive() (hxutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
	...
	amount, err := hxutil.NewAmount(balance)
	if err != nil {
		return 0, err
	}
...
// confirmations.
func (c *Client) GetReceivedByAccount(account string) (hxutil.Amount, error) {
...
func (c *Client) GetReceivedByAccountMinConf(account string, minConfirms int) (hxutil.Amount, error) {
...
func (r FutureGetUnconfirmedBalanceResult) Receive() (hxutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetUnconfirmedBalance(account string) (hxutil.Amount, error) {
...
func (r FutureGetReceivedByAddressResult) Receive() (hxutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
// confirmations.
func (c *Client) GetReceivedByAddress(address hxutil.Address) (hxutil.Amount, error) {
...
func (c *Client) GetReceivedByAddressMinConf(address hxutil.Address, minConfirms int) (hxutil.Amount, error) {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SignMessage(address hxutil.Address, message string) (string, error) {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) VerifyMessage(address hxutil.Address, signature, message string) (bool, error) {
...
// (WIF)
func (r FutureDumpPrivKeyResult) Receive() (*hxutil.WIF, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return hxutil.DecodeWIF(privKeyWIF)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) DumpPrivKey(address hxutil.Address) (*hxutil.WIF, error) {
...
func (c *Client) ImportPrivKeyAsync(privKeyWIF *hxutil.WIF) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
...
// format (WIF).
func (c *Client) ImportPrivKey(privKeyWIF *hxutil.WIF) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyLabelAsync(privKeyWIF *hxutil.WIF, label string) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyLabel(privKeyWIF *hxutil.WIF, label string) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyRescanAsync(privKeyWIF *hxutil.WIF, label string, rescan bool) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyRescan(privKeyWIF *hxutil.WIF, label string, rescan bool) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyRescanFromAsync(privKeyWIF *hxutil.WIF, label string, rescan bool, scanFrom int) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyRescanFrom(privKeyWIF *hxutil.WIF, label string, rescan bool, scanFrom int) error {
...
func (c *Client) AddTicket(ticket *hxutil.Tx) error {
...
func (c *Client) SetTicketFee(fee hxutil.Amount) error {
...
func (c *Client) SetTxFee(fee hxutil.Amount) error {

...
//
// NOTE: This is a hxd extension.
func (c *Client) DebugLevelAsync(levelSpec string) FutureDebugLevelResult {
	cmd := hxjson.NewDebugLevelCmd(levelSpec)
	return c.sendCmd(cmd)
}
...
func (r FutureEstimateStakeDiffResult) Receive() (*hxjson.EstimateStakeDiffResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var est hxjson.EstimateStakeDiffResult
...
func (c *Client) EstimateStakeDiffAsync(tickets *uint32) FutureEstimateStakeDiffResult {
	cmd := hxjson.NewEstimateStakeDiffCmd(tickets)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a hxd extension.
func (c *Client) EstimateStakeDiff(tickets *uint32) (*hxjson.EstimateStakeDiffResult, error) {
...
// result of the RPC at some future time by invoking the Receive function on the
// returned instance.
func (c *Client) ExistsAddressAsync(address hxutil.Address) FutureExistsAddressResult {
	cmd := hxjson.NewExistsAddressCmd(address.EncodeAddress())
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a hxd extension.
func (c *Client) ExistsAddress(address hxutil.Address) (bool, error) {
...
// result of the RPC at some future time by invoking the Receive function on the
// returned instance.
func (c *Client) ExistsAddressesAsync(addresses []hxutil.Address) FutureExistsAddressesResult {
	addrsStr := make([]string, len(addresses))
	for i := range addresses {
		addrsStr[i] = addresses[i].EncodeAddress()
	}

	cmd := hxjson.NewExistsAddressesCmd(addrsStr)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a hxd extension.
func (c *Client) ExistsAddresses(addresses []hxutil.Address) (string, error) {
...
func (c *Client) ExistsMissedTicketsAsync(hashes []*chainhash.Hash) FutureExistsMissedTicketsResult {
	...
	cmd := hxjson.NewExistsMissedTicketsCmd(hex.EncodeToString(hashBlob))
	return c.sendCmd(cmd)
}
...
func (c *Client) ExistsExpiredTicketsAsync(hashes []*chainhash.Hash) FutureExistsExpiredTicketsResult {
	...
	cmd := hxjson.NewExistsExpiredTicketsCmd(hex.EncodeToString(hashBlob))
	return c.sendCmd(cmd)
}
...
func (c *Client) ExistsLiveTicketAsync(hash *chainhash.Hash) FutureExistsLiveTicketResult {
	cmd := hxjson.NewExistsLiveTicketCmd(hash.String())
	return c.sendCmd(cmd)
}
...
func (c *Client) ExistsLiveTicketsAsync(hashes []*chainhash.Hash) FutureExistsLiveTicketsResult {
	...
	cmd := hxjson.NewExistsLiveTicketsCmd(hex.EncodeToString(hashBlob))
	return c.sendCmd(cmd)
}
...
func (c *Client) ExistsMempoolTxsAsync(hashes []*chainhash.Hash) FutureExistsMempoolTxsResult {
	...
	cmd := hxjson.NewExistsMempoolTxsCmd(hex.EncodeToString(hashBlob))
	return c.sendCmd(cmd)
}
...
func (c *Client) ExportWatchingWalletAsync(account string) FutureExportWatchingWalletResult {
	cmd := hxjson.NewExportWatchingWalletCmd(&account, hxjson.Bool(true))
	return c.sendCmd(cmd)
}
...
// used by hxwallet to enable a wallet which does not have the private keys
...
func (r FutureGetBestBlockResult) Receive() (*chainhash.Hash, int64, error) {
	...
	var bestBlock hxjson.GetBestBlockResult
...
func (c *Client) GetCurrentNetAsync() FutureGetCurrentNetResult {
	cmd := hxjson.NewGetCurrentNetCmd()
	return c.sendCmd(cmd)
}
...
// Receive waits for the response promised by the future and returns the
// getheaders result.
func (r FutureGetHeadersResult) Receive() (*hxjson.GetHeadersResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var vr hxjson.GetHeadersResult
...
func (c *Client) GetHeadersAsync(blockLocators []*chainhash.Hash, hashStop *chainhash.Hash) FutureGetHeadersResult {
	...
	cmd := hxjson.NewGetHeadersCmd(hex.EncodeToString(concatenatedLocators),
		hashStop.String())
	return c.sendCmd(cmd)
}
...
func (c *Client) GetHeaders(blockLocators []*chainhash.Hash, hashStop *chainhash.Hash) (*hxjson.GetHeadersResult, error) {
...
// Receive waits for the response promised by the future and returns the network
// the server is running on.
func (r FutureGetStakeDifficultyResult) Receive() (*hxjson.GetStakeDifficultyResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}

	// Unmarshal result as a hxjson.GetStakeDifficultyResult.
	var gsdr hxjson.GetStakeDifficultyResult
...
func (c *Client) GetStakeDifficultyAsync() FutureGetStakeDifficultyResult {
	cmd := hxjson.NewGetStakeDifficultyCmd()
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a hxd extension.
func (c *Client) GetStakeDifficulty() (*hxjson.GetStakeDifficultyResult, error) {
...
// Receive waits for the response promised by the future and returns the network
// the server is running on.
func (r FutureGetStakeVersionsResult) Receive() (*hxjson.GetStakeVersionsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}

	// Unmarshal result as a hxjson.GetStakeVersionsResult.
	var gsvr hxjson.GetStakeVersionsResult
...
func (c *Client) GetStakeVersionInfoAsync(count int32) FutureGetStakeVersionInfoResult {
	cmd := hxjson.NewGetStakeVersionInfoCmd(count)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a hxd extension.
func (c *Client) GetStakeVersionInfo(count int32) (*hxjson.GetStakeVersionInfoResult, error) {
...
// Receive waits for the response promised by the future and returns the network
// the server is running on.
func (r FutureGetStakeVersionInfoResult) Receive() (*hxjson.GetStakeVersionInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}

	// Unmarshal result as a hxjson.GetStakeVersionInfoResult.
	var gsvr hxjson.GetStakeVersionInfoResult
	err = json.Unmarshal(res, &gsvr)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetStakeVersionsAsync(hash string, count int32) FutureGetStakeVersionsResult {
	cmd := hxjson.NewGetStakeVersionsCmd(hash, count)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a hxd extension.
func (c *Client) GetStakeVersions(hash string, count int32) (*hxjson.GetStakeVersionsResult, error) {
...
// Receive waits for the response promised by the future and returns the network
// the server is running on.
func (r FutureGetTicketPoolValueResult) Receive() (hxutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetTicketPoolValueAsync() FutureGetTicketPoolValueResult {
	cmd := hxjson.NewGetTicketPoolValueCmd()
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a hxd extension.
func (c *Client) GetTicketPoolValue() (hxutil.Amount, error) {
...
// Receive waits for the response promised by the future and returns the network
// the server is running on.
func (r FutureGetVoteInfoResult) Receive() (*hxjson.GetVoteInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}

	// Unmarshal result as a hxjson.GetVoteInfoResult.
	var gsvr hxjson.GetVoteInfoResult
	err = json.Unmarshal(res, &gsvr)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetVoteInfoAsync(version uint32) FutureGetVoteInfoResult {
	cmd := hxjson.NewGetVoteInfoCmd(version)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a hxd extension.
func (c *Client) GetVoteInfo(version uint32) (*hxjson.GetVoteInfoResult, error) {
...
func (r FutureListAddressTransactionsResult) Receive() ([]hxjson.ListTransactionsResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
...
//
// NOTE: This is a hxd extension.
func (c *Client) ListAddressTransactionsAsync(addresses []hxutil.Address, account string) FutureListAddressTransactionsResult {
	// Convert addresses to strings.
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.EncodeAddress())
	}
	cmd := hxjson.NewListAddressTransactionsCmd(addrs, &account)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a hxwallet extension.
func (c *Client) ListAddressTransactions(addresses []hxutil.Address, account string) ([]hxjson.ListTransactionsResult, error) {
...
func (r FutureLiveTicketsResult) Receive() ([]*chainhash.Hash, error) {
	...
	// Unmarshal the result as a hxjson.LiveTicketsResult.
	var container hxjson.LiveTicketsResult
...
func (r FutureMissedTicketsResult) Receive() ([]*chainhash.Hash, error) {
	...
	// Unmarshal the result as a hxjson.MissedTicketsResult.
	var container hxjson.MissedTicketsResult
	err = json.Unmarshal(res, &container)
	if err != nil {
		return nil, err
	}
...
func (c *Client) MissedTicketsAsync() FutureMissedTicketsResult {
	cmd := hxjson.NewMissedTicketsCmd()
	return c.sendCmd(cmd)
}
...
// Receive waits for the response promised by the future and returns the
// session result.
func (r FutureSessionResult) Receive() (*hxjson.SessionResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var session hxjson.SessionResult
...
//
// NOTE: This is a Decred extension.
func (c *Client) Session() (*hxjson.SessionResult, error) {
...
func (r FutureTicketFeeInfoResult) Receive() (*hxjson.TicketFeeInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var tfir hxjson.TicketFeeInfoResult
...
func (c *Client) TicketFeeInfoAsync(blocks *uint32, windows *uint32) FutureTicketFeeInfoResult {
	...
	cmd := hxjson.NewTicketFeeInfoCmd(blocks, windows)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a Decred extension.
func (c *Client) TicketFeeInfo(blocks *uint32, windows *uint32) (*hxjson.TicketFeeInfoResult, error) {
...
// Receive waits for the response promised by the future and returns the
// ticketvwap result.
func (r FutureTicketVWAPResult) Receive() (hxutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) TicketVWAPAsync(start *uint32, end *uint32) FutureTicketVWAPResult {
	...
	cmd := hxjson.NewTicketVWAPCmd(start, end)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a Decred extension.
func (c *Client) TicketVWAP(start *uint32, end *uint32) (hxutil.Amount, error) {
...
// Receive waits for the response promised by the future and returns the
// txfeeinfo result.
func (r FutureTxFeeInfoResult) Receive() (*hxjson.TxFeeInfoResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var tfir hxjson.TxFeeInfoResult
	err = json.Unmarshal(res, &tfir)
	if err != nil {
		return nil, err
	}
...
func (c *Client) TxFeeInfoAsync(blocks *uint32, start *uint32, end *uint32) FutureTxFeeInfoResult {
	...
	cmd := hxjson.NewTxFeeInfoCmd(blocks, start, end)
	return c.sendCmd(cmd)
}
...
//
// NOTE: This is a Decred extension.
func (c *Client) TxFeeInfo(blocks *uint32, start *uint32, end *uint32) (*hxjson.TxFeeInfoResult, error) {
...
// result.
func (r FutureVersionResult) Receive() (map[string]hxjson.VersionResult, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	var vr map[string]hxjson.VersionResult
	err = json.Unmarshal(res, &vr)
	if err != nil {
		return nil, err
	}
...
func (c *Client) VersionAsync() FutureVersionResult {
	cmd := hxjson.NewVersionCmd()
	return c.sendCmd(cmd)
}

// Version returns information about the server's JSON-RPC API versions.
func (c *Client) Version() (map[string]hxjson.VersionResult, error) {

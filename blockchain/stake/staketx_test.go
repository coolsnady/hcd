...
func TestSStx(t *testing.T) {
	var sstx = hxutil.NewTx(sstxMsgTx)
	...
	sstx = hxutil.NewTxDeep(sstxMsgTx)
...
func TestSSTxErrors(t *testing.T) {
	...
	var sstxExtraInputs = hxutil.NewTx(sstxMsgTxExtraInput)
	...
	var sstxExtraOutputs = hxutil.NewTx(sstxMsgTxExtraOutputs)
	...
	var sstxUntaggedOut = hxutil.NewTx(&tx)
	...
	var sstxInsOutsMismatched = hxutil.NewTx(sstxMismatchedInsOuts)
	...
	var sstxBadVerOut = hxutil.NewTx(sstxBadVersionOut)
	...
	var sstxNoNullData = hxutil.NewTx(sstxNullDataMissing)
	...
	var sstxNullDataMis = hxutil.NewTx(sstxNullDataMisplaced)
	...
	var sstxWrongPKHLength = hxutil.NewTx(&tx)
	...
	var sstxWrongPrefix = hxutil.NewTx(&tx)
...
func TestSSGen(t *testing.T) {
	var ssgen = hxutil.NewTx(ssgenMsgTx)
	...
	ssgen = hxutil.NewTxDeep(ssgenMsgTx)
	ssgen.SetTree(wire.TxTreeStake)
	ssgen.SetIndex(0)
...
func TestSSGenErrors(t *testing.T) {
	...
	var ssgenExtraInputs = hxutil.NewTx(ssgenMsgTxExtraInput)
	...
	var ssgenExtraOutputs = hxutil.NewTx(ssgenMsgTxExtraOutputs)
	...
	var ssgenStakeBaseWrong = hxutil.NewTx(ssgenMsgTxStakeBaseWrong)
	...
	var ssgenWrongTreeIns = hxutil.NewTx(&tx)
	...
	// ---------------------------------------------------------------------------
	// Test for bad version of output.
	var ssgenTxBadVerOut = hxutil.NewTx(ssgenMsgTxBadVerOut)
	...
	var ssgenWrongZeroethOut = hxutil.NewTx(ssgenMsgTxWrongZeroethOut)
	...
	var ssgenWrongDataPush0Length = hxutil.NewTx(&tx)
	...
	var ssgenWrongNullData0Prefix = hxutil.NewTx(&tx)
	...
	var ssgenWrongFirstOut = hxutil.NewTx(ssgenMsgTxWrongFirstOut)
	...
	var ssgenWrongDataPush1Length = hxutil.NewTx(&tx)
	...
	var ssgenWrongNullData1Prefix = hxutil.NewTx(&tx)
	...
	var ssgentestGenOutputUntagged = hxutil.NewTx(&tx)
...
func TestSSRtx(t *testing.T) {
	var ssrtx = hxutil.NewTx(ssrtxMsgTx)
...
func TestIsSSRtxErrors(t *testing.T) {
	...
	var ssrtxTooManyInputs = hxutil.NewTx(ssrtxMsgTxTooManyInputs)
	...
	var ssrtxTooManyOutputs = hxutil.NewTx(ssrtxMsgTxTooManyOutputs)
	...
	// ---------------------------------------------------------------------------
	// Test for bad version of output.
	var ssrtxTxBadVerOut = hxutil.NewTx(ssrtxMsgTxBadVerOut)
	...
	var ssrtxTestRevocOutputUntagged = hxutil.NewTx(&tx)
	...
	var ssrtxWrongTreeIns = hxutil.NewTx(&tx)

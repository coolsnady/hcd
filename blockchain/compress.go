...
const (
	...
	// special script types are currently stored by Hcd, there is a large
...
// isPubKeyHashAlt returns whether or not the passed public key script is a
// bliss pay-to-pubkey-hash script along with the bliss pubkey hash it is paying
// ot if it is.
...
func putCompressedScript(target []byte, scriptVersion uint16, pkScript []byte,
	...
	// bliss Pay-to-pubkey-hash script.
...
// of 0.1 HC which is 10000000 atoms.  Encoding 10000000 as a VarInt would take
...
// -----------------------------------------------------------------------------
// Hcd specific transaction encoding flags
//

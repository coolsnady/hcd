...
import (
	...
	"github.com/coolsnady/hcd/blockchain/internal/dbnamespace"
...
// The amount is never encoded into spent transaction outputs in Hcd
...
func decodeSpentTxOut(serialized []byte, stxo *spentTxOut, amount int64,
	...
	// since in Hcd we only need pkScript at most due to fraud proofs

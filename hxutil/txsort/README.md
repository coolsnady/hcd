...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/coolsnady/hxd/hxutil/txsort)
...
```bash
$ go get -u github.com/coolsnady/hxd/hxutil/txsort
```

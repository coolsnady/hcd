...
// units, "1eN HX" is returned, where N is the AmountUnit.
...
//
// NewAmount is for specifically for converting HX to Atoms (atomic units).
...
// See GoDoc for example: http://godoc.org/github.com/coolsnady/hxd/dcrutil#example-Amount
